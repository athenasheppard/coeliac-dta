...
display %4.0f 200 * ( exp( e(b)[1,1] ) / ( 1 + exp( e(b)[1,1] ) ) ) // tp
display %4.0f 200 - ( 200 * ( exp( e(b)[1,1] ) / ( 1 + exp( e(b)[1,1] ) ) ) ) // fn
display %4.0f 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) // tn
display %4.0f 9800 - ( 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) ) // fp
cii proportions 1412 181 // ppv confidence interval
cii proportions 8588 8569 // npv confidence interval
* Summary ROC plot
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9065 0.8744, m(diamond) mc(black) msiz(medsmall) || ///
...
display %4.0f 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) // tn
display %4.0f 9800 - ( 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) ) // fp
cii proportions 199 174 // ppv confidence interval
cii proportions 9801 9775 // npv confidence interval
* Summary ROC plot
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.8801 0.9961, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9643 0.9544, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9364 0.9936, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN, ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9149 0.9670, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9355 0.8632, m(diamond) mc(black) msiz(medsmall) || ///
...
display %4.0f 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) // tn
display %4.0f 9800 - ( 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) ) // fp
cii proportions 3116 195 // ppv confidence interval
cii proportions 6884 6879 // npv confidence interval
* Summary ROC plot
gen common_thresh = (Index_threshold == "20 U/mL") // create variable indicating most commonly reported threshold
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9769 0.7019, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN, ///
	...
	addplot(scatter sens spec [aw = weight], m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatteri . ., msiz(medium) mfc(ebblue%20) mlc(ebblue%70))
...
display %4.0f 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) // tn
display %4.0f 9800 - ( 9800 * ( exp( e(b)[1,2] ) / ( 1 + exp( e(b)[1,2] ) ) ) ) // fp
cii proportions 1012 188 // ppv confidence interval
cii proportions 8988 8976 // npv confidence interval
* Summary ROC plot
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9448 0.9380, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9640 0.7740, m(diamond) mc(black) msiz(medsmall) || ///
...
metandiplot TP FP FN TN if spec != ., ///
	...
	addplot(scatter sens spec [aw = weight] if common_thresh == 0, m(smcircle) mfc(ebblue%20) mlc(ebblue%70) msiz(small) || ///
	scatter sens spec [aw = weight] if common_thresh == 1, m(smcircle) mfc(pink%20) mlc(pink%70) msiz(small) || ///
	scatteri 0.9564 0.6216, m(diamond) mc(black) msiz(medsmall) || ///
